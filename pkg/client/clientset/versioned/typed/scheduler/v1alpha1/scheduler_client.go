...
type SchedulerV1alpha1Interface interface {
	...
	IntegrationScenariosGetter
}

// SchedulerV1alpha1Client is used to interact with features provided by the scheduler.kraken.dev group.
type SchedulerV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SchedulerV1alpha1Client) IntegrationScenarios(namespace string) IntegrationScenarioInterface {
	return newIntegrationScenarios(c, namespace)
}
