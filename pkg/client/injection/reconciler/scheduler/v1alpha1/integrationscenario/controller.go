...
import (
	...
	versionedscheme "kraken.dev/kraken-scheduler/pkg/client/clientset/versioned/scheme"
	injectionclient "kraken.dev/kraken-scheduler/pkg/client/injection/client"
	integrationscenario "kraken.dev/kraken-scheduler/pkg/client/injection/informers/scheduler/v1alpha1/integrationscenario"
)

const (
	defaultControllerAgentName = "integrationscenario-controller"
	defaultFinalizerName       = "integrationscenarios.scheduler.kraken.dev"
	defaultQueueName           = "integrationscenarios"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:     integrationscenarioInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
