...
import (
	...
	fake "kraken.dev/kraken-scheduler/pkg/client/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch kraken.dev/kraken-scheduler/pkg/client/clientset/versioned/fake.Clientset from context.")
	}
