...
import (
	...
	externalversions "kraken.dev/kraken-scheduler/pkg/client/informers/externalversions"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch kraken.dev/kraken-scheduler/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
